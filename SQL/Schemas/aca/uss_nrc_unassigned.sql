USE aca;
SELECT ee.qms_stfacq_error_id, ee.qms_key, ee.system_name, ee.assigned_to_org_id, oo.org_label, ee.assigned_to_user_id, uu.display_name, uu.email_address, ooo.org_label, ee.resolved_at
